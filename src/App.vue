...
/*eslint-disable*/
  ...
  const informationData = ref([
    {
      url:require('./assets/img/news-1.png'),
      title:'這是標題1',
    ...
    {
      url:require('./assets/img/news-2.png'),
      title:'這是標題2',
      time:'2023-04-29 10:02:20',
      imgText:'狗狗不但順利從桌上拿下手電筒，還馬上按下電源測試。圖/翻攝自微博',
      content1:'不少人認為狗狗是一種非常聰明且易於訓練的動物，有些品種的狗狗智商甚至和3、4歲的兒童不相上下。有飼主就在微博上分享自家黃金獵犬不但能和她遠端通話，甚至還會在夜晚拿著手電筒去接她回家。',
    ...
    {
      url:require('./assets/img/news-3.png'),
      title:'這是標題3',
      time:'2023-04-29 10:02:20',
      imgText:'狗狗不但順利從桌上拿下手電筒，還馬上按下電源測試。圖/翻攝自微博',
      content1:'不少人認為狗狗是一種非常聰明且易於訓練的動物，有些品種的狗狗智商甚至和3、4歲的兒童不相上下。有飼主就在微博上分享自家黃金獵犬不但能和她遠端通話，甚至還會在夜晚拿著手電筒去接她回家。',
    ...
    {
      url:require('./assets/img/news-4.png'),
      title:'這是標題4',
      time:'2023-04-29 10:02:20',
      imgText:'狗狗不但順利從桌上拿下手電筒，還馬上按下電源測試。圖/翻攝自微博',
      content1:'不少人認為狗狗是一種非常聰明且易於訓練的動物，有些品種的狗狗智商甚至和3、4歲的兒童不相上下。有飼主就在微博上分享自家黃金獵犬不但能和她遠端通話，甚至還會在夜晚拿著手電筒去接她回家。',
    ...
    {
      url:require('./assets/img/news-5.png'),
      title:'這是標題5',
      time:'2023-04-29 10:02:20',
      imgText:'狗狗不但順利從桌上拿下手電筒，還馬上按下電源測試。圖/翻攝自微博',
      content1:'不少人認為狗狗是一種非常聰明且易於訓練的動物，有些品種的狗狗智商甚至和3、4歲的兒童不相上下。有飼主就在微博上分享自家黃金獵犬不但能和她遠端通話，甚至還會在夜晚拿著手電筒去接她回家。',
